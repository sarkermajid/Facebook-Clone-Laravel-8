                        ...
                        <div class=" col-sm-6">
                            <div class="signup-form">
                                ...
                                <form action="{{ route('saveRegister') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input type="email" placeholder="Email Address" name="email" class="input-lg col-sm-12" value="{{ old('email') }}"/>
                                        @error('email')
                                        <div class="alert alert-danger"> {{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <input type="password" placeholder="New Password" name="password" class="input-lg col-sm-12" value="{{ old('password') }}"/>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-4">
                                            <input type="radio" name="male" value="male" id="sex_male">
                                            <label for="sex_male" class="input-lg">Male </label>
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="radio" name="female" value="female" id="sex_female">
