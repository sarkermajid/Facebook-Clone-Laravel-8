                    ...
                    <div class="pull-right col-sm-6 text-center">
                        <div class="login-form">
                            ...
                            <form action="{{ route('saveLogin') }}" method="post" style="max-width:400px;margin:0px auto;">
                                ...
                                <div class="form-group">
                                    <input type="password" placeholder="Password" name="password" class="input-lg col-sm-12 @error('password') is-invalid @enderror" required/>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    <br/><br/><br/><br/>
                                    <a href="{{ route('dashboard') }}">Signup for FaceClone</a>
                                </div>
                            </form>
                        </div>
                    </div>
